...
<html>
  ...
  <body>
    ...
    <div style="position: absolute; top: 15%; left: 20px">
      <a href="/admin/hall" class="btn btn-secondary" style="color: white"
        >Back</a
      >
    </div>
    <h2 style="text-align: center; margin-top: 20px">Add Hall</h2>
    <spring:form
      method="post"
    ...
    >
      <div class="form-group m-4">
        <label style="margin-left: 25%" for="name">Hall Name</label>
        <spring:input
          type="text"
      ...
      <div class="form-group m-4">
        <label style="margin-left: 25%" for="address">Address</label>
        <spring:input
          type="text"
          class="form-control border border-primary"
          style="margin-left: 25%; width: 50%"
      ...
      <div class="form-group m-4">
        <label style="margin-left: 25%" for="capacity">Capacity</label>
        <spring:input
          type="number"
          class="form-control border border-primary"
          style="margin-left: 25%; width: 50%"
    ...
    <c:if test="${added!=null}">
      <script>
        swal("Added!", "Hall added successfully!", "success");
      </script>
    </c:if>
  </body>
</html>
